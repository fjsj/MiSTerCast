...
{
    // No endpoint is listening on this loopback port. INIT must time out, clean
    // up its pending RIO operations, and tolerate both explicit and destructor
    // cleanup without touching a queue, buffer registration, or socket twice.
    {
        GroovyMister transport;
